...
CREATE TABLE IF NOT EXISTS `istabas` (
  ...
  `viesnica` int(11) NOT NULL COMMENT 'Dienesta viesnīcas identifikators',
...
INSERT INTO `istabas` (`ID`, `ires_cena`, `Vietas`, `viesnica`, `istabas_numurs`, `radit`, `apraksts`, `ir_izirejama`) VALUES
...
CREATE TABLE IF NOT EXISTS `istabu_atteli` (
  ...
  `istabas_numurs` int(11) NOT NULL COMMENT 'Istabiņas identifikators',
  `attels` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT 'Attēla nosaukums',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID` (`ID`),
  KEY `istabas_numurs` (`istabas_numurs`)
...
INSERT INTO `istabu_atteli` (`ID`, `istabas_numurs`, `attels`) VALUES
...
CREATE TABLE IF NOT EXISTS `istabu_pieprasijumi` (
  ...
  `istabas_id` int(11) NOT NULL COMMENT 'Pieprasītās istabiņas identifikators',
  `statuss` varchar(45) NOT NULL COMMENT 'Pieprasījuma statuss',
  `administrators` int(11) NOT NULL COMMENT 'Pārvaldnieka identifikators',
  `students` int(11) NOT NULL COMMENT 'Studenta identifikators',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID` (`ID`),
  KEY `istabas_id` (`istabas_id`),
  KEY `administrators` (`administrators`),
...
INSERT INTO `istabu_pieprasijumi` (`ID`, `istabas_id`, `statuss`, `administrators`, `students`) VALUES
(1, 1, 'Atteikts', 1, 3),
...
CREATE TABLE IF NOT EXISTS `jaunumi` (
  ...
  `kategorija` int(11) NOT NULL COMMENT 'Viesnīcas identifikators',
  `autors` int(11) NOT NULL COMMENT 'Administratora identifikators',
...
INSERT INTO `jaunumi` (`ID`, `virsraksts`, `saturs`, `kategorija`, `autors`, `pievienosanas_datums`) VALUES
...
CREATE TABLE IF NOT EXISTS `ligumi` (
  ...
  `studenta_id` int(11) NOT NULL COMMENT 'Students, ar kuru līgums noslēgts',
...
INSERT INTO `ligumi` (`ID`, `studenta_id`, `no`, `lidz`, `liguma_numurs`, `komentars`) VALUES
...
INSERT INTO `maksajumi` (`ID`, `datums_no`, `datums_lidz`, `students`, `statuss`, `datums`, `daudzums`) VALUES
...
CREATE TABLE IF NOT EXISTS `studenti` (
  ...
  `istabas_numurs` int(11) DEFAULT NULL COMMENT 'Istabiņa, kuru students īrē',
  `parole` varchar(100) NOT NULL COMMENT 'Parole šifrētā veidā',
...
INSERT INTO `studenti` (`ID`, `id_numurs`, `vards`, `uzvards`, `kurss`, `fakultate`, `istabas_numurs`, `parole`, `epasts`) VALUES
...
CREATE TABLE IF NOT EXISTS `vestules` (
  ...
  `autors` int(11) NOT NULL COMMENT 'Administratora identifikators',
  `sanemejs` int(11) NOT NULL COMMENT 'Studenta identifikators',
  `datums` datetime NOT NULL COMMENT 'Datums, kad ziņojums izsūtīts',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID` (`ID`),
  KEY `autors` (`autors`),
  KEY `sanemejs` (`sanemejs`),
  KEY `autors_2` (`autors`),
  KEY `sanemejs_2` (`sanemejs`)
...
INSERT INTO `vestules` (`ID`, `virsraksts`, `saturs`, `autors`, `sanemejs`, `datums`) VALUES
...
--
ALTER TABLE `istabas`
  ADD CONSTRAINT `Viesnīcu istabas ID` FOREIGN KEY (`viesnica`) REFERENCES `viesnicas` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `istabu_atteli`
--
ALTER TABLE `istabu_atteli`
  ADD CONSTRAINT `Istabu attēlu identifikators` FOREIGN KEY (`istabas_numurs`) REFERENCES `istabas` (`ID`);

--
-- Constraints for table `istabu_pieprasijumi`
--
ALTER TABLE `istabu_pieprasijumi`
  ADD CONSTRAINT `Studenta, kurš pieprasa istabiņu, ID` FOREIGN KEY (`students`) REFERENCES `studenti` (`ID`),
  ADD CONSTRAINT `DV pārvaldnieka ID` FOREIGN KEY (`administrators`) REFERENCES `administratori` (`ID`),
  ADD CONSTRAINT `Istaba, kuru pieprasa` FOREIGN KEY (`istabas_id`) REFERENCES `istabas` (`ID`);

--
-- Constraints for table `jaunumi`
--
ALTER TABLE `jaunumi`
  ADD CONSTRAINT `Viesnīcas ID, uz kuru attiecas raksts` FOREIGN KEY (`kategorija`) REFERENCES `viesnicas` (`ID`),
  ADD CONSTRAINT `Administrators, kurš ir jaunumu autors` FOREIGN KEY (`autors`) REFERENCES `administratori` (`ID`);

--
-- Constraints for table `ligumi`
--
ALTER TABLE `ligumi`
  ADD CONSTRAINT `Studenta ID, ar kuru noslēgts līgums` FOREIGN KEY (`studenta_id`) REFERENCES `studenti` (`ID`);

--
-- Constraints for table `maksajumi`
--
ALTER TABLE `maksajumi`
  ADD CONSTRAINT `Studenta ID, kurš veic maksājumu` FOREIGN KEY (`students`) REFERENCES `studenti` (`ID`);

--
-- Constraints for table `studenti`
--
ALTER TABLE `studenti`
  ADD CONSTRAINT `Istaba, kuru students īrē` FOREIGN KEY (`istabas_numurs`) REFERENCES `istabas` (`ID`);

--
-- Constraints for table `vestules`
--
ALTER TABLE `vestules`
  ADD CONSTRAINT `Students, kurš saņem vēstuli` FOREIGN KEY (`sanemejs`) REFERENCES `studenti` (`ID`),
  ADD CONSTRAINT `Administrators, kurš sūta vēstuli` FOREIGN KEY (`autors`) REFERENCES `administratori` (`ID`);
